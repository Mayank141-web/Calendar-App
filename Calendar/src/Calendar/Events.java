...
public class Events extends JPanel {
    ...
    private void refreshTasks() {
        ...
        if (tasks.isEmpty()) {
            ...
            emptyLabel.setForeground(Color.decode("#00d1e8"));
            ...
            for (Task task : tasks) {
                ...
                taskLabel.setForeground(Color.decode("#00d1e8"));

                // Edit button
                JButton editButton = new JButton("✎");
                editButton.setFont(new Font("Helvetica", Font.BOLD, 16));
                editButton.setForeground(Color.decode("#0ecf78"));
                ...
                editButton.addActionListener(e ->
                        new TaskEditor(task, taskManager, mainPanel, currentDate));

                // Delete button
                JButton deleteButton = new JButton("×");
                deleteButton.setFont(new Font("Helvetica", Font.BOLD, 16));
                deleteButton.setForeground(Color.decode("#0ecf78"));
