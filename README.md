...
![Calendar App Screenshot](assets/screenshot.png)

The app is split into two panels: a **monthly calendar** on the left and a **task list** on the right. The current day is highlighted in green, and any day that already has tasks is highlighted in teal — giving you a quick visual overview of your schedule at a glance. Clicking any day instantly updates the task panel on the right, where you can add, edit, or delete tasks for that date.
...
A pre-built macOS installer is available on the [Releases](../../releases) page.

| Platform | Download |
|----------|----------|
| macOS | [CalendarApp.dmg](../../releases/latest) |

Mount the `.dmg`, drag **CalendarApp** to your Applications folder, and run — no Java installation required.

> **Note:** On first launch, macOS may block the app since it isn't notarized. To open it, go to **System Settings → Privacy & Security** and click **Open Anyway**.
